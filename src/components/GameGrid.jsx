			...
			<div className="flex flex-col">
				<div className="relative flex items-center justify-center w-full h-full">
					...
					<div
						...
						<div className="relative flex flex-col items-center md:flex-row md:justify-center lg:gap-52 px-4 sm:px-8 md:px-12 lg:px-16 xl:px-24 md:py-4 lg:mt-[10%] sm:mt-[5%] mt-0 xl:mt-[16%]">
						...
						>
							{/* Top Horizontal Reel */}
							<div className="grid grid-cols-4 lg:w-[320px] gap-4 lg:gap-0 sm:mb-2 lg:mb-8 xl:mb-2"> 
